<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OcrSum.aspx.cs" Inherits="Comdat.DOZP.Web.Statistics.OcrSum" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h1><asp:Label ID="TitleLabel" runat="server" Text="<%$ Resources:DOZP,StatisticsOcrSum %>"></asp:Label></h1>
    <table>
        <tr>
        ...
        <ContentTemplate>            
            <asp:GridView ID="StatisticsGridView" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="TableOfContentsComplete" HeaderText="Obsahy" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="Pages" HeaderText="Stránky" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="OcrTime" HeaderText="Čas zpracování" DataFormatString="{0:%d} dni {0:hh\:mm\:ss}" HeaderStyle-HorizontalAlign="Center" ItemStyle-HorizontalAlign="Center" />
                </Columns>
            </asp:GridView>
        </ContentTemplate>
    </asp:UpdatePanel>
    <asp:ObjectDataSource ID="StatisticsDataSource" runat="server" 
        ...
        <SelectParameters>
            ...
            <asp:Parameter Name="partOfBook" Type="Int16" ConvertEmptyStringToNull="true" />
            <asp:Parameter Name="useOCR" Type="Boolean" ConvertEmptyStringToNull="true" DefaultValue="true" />
