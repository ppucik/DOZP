...
namespace Comdat.DOZP.App
{
    ...
    public partial class AboutDialog : Window
    {
        ...
        /// <summary>
        /// Constructor that takes a parent for this AboutDialog dialog.
        /// </summary>
        ...
        private void hyperlink_RequestNavigate(object sender, System.Windows.Navigation.RequestNavigateEventArgs e)
        {
            if (e.Uri != null && String.IsNullOrEmpty(e.Uri.OriginalString) == false)
            {
                ...
                System.Diagnostics.Process.Start(new ProcessStartInfo(uri));
                e.Handled = true;
            }
        }
        ...
        public string Description
        {
            get
            {
                StringBuilder sb = new StringBuilder(CalculatePropertyValue<AssemblyDescriptionAttribute>(propertyNameDescription, xPathDescription));
                sb.AppendLine("Uživatel: " + Environment.UserDomainName);
                sb.AppendLine("Počítač: " + Environment.MachineName);
                sb.AppendLine("Adresář aplikace: " + Environment.CurrentDirectory);
                sb.AppendLine("Verze OS: " + Environment.OSVersion);
